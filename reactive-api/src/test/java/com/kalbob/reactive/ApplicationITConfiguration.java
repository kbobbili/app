...
//@TestPropertySource(properties= {"spring.autoconfigure.exclude=com.kalbob.reactive.xyz.XyzAutoConfiguration"}, locations = {"classpath:if-you-need-some-other-file.yml"})
